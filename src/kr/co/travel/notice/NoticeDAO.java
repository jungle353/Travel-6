...
public class NoticeDAO {
	...
	public NoticeDTO updatUI(int num) {
	...
	public void update(NoticeDTO noticeDTO) {
		...
		Connection conn = null;
		PreparedStatement pstmt = null;
		String sql = "update notice set writer=?, title=?, content=? where num =?";
		...
		try {
			...
			pstmt.setInt(4, noticeDTO.getNum());
	...
	public Notice_PageTO page(int curPage) {
		...
		Notice_PageTO to = new Notice_PageTO(curPage);
		List<NoticeDTO> list = new ArrayList<NoticeDTO>();
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public boolean login(Notice_LoginDTO notice_LoginDTO) {
	...
	public List<CommentDTO> cList(int num) {
		...
		try {
			...
			while (rs.next()) {
				...
				cList.add(new CommentDTO(comment_num, comment_board, comment_content, comment_writer, comment_day, comment_repRoot,
	...
	public void comment_insert(CommentDTO commentDTO) {
		Connection conn = null;
		PreparedStatement pstmt = null;
	...
	private void stepPlus(Connection conn, CommentDTO orgDTO) {
		PreparedStatement pstmt = null;
	...
	public void reply(int orgnum, CommentDTO dto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		String sql = "insert into notice_comment (comment_num, comment_board, comment_content, comment_writer, repRoot, repStep, repIndent) values (?, ?, ?, ?, ?, ?, ?)";
		...
		try {
			...
			CommentDTO orgDTO = updateUI(orgnum); //원래글 정보 가져옴
	...
	public CommentDTO updateUI(int comment_num) {
		CommentDTO dto = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			if(rs.next()) {
				...
				dto = new CommentDTO(comment_num, comment_board, comment_content, comment_writer, comment_day, repRoot, repStep, repIndent);
